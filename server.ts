...
app.get('/api/tools/windows-installer-script', (req: Request, res: Response) => {
  const ps1Lines = [
    ...
    '# Features: System Tray Daemon next to clock, Minimize on X, Custom Hotkeys & Wake Words',
    ...
    '',
    'Write-Host "[1/4] Preparing Abel AI Directory at: $InstallDir..." -ForegroundColor Cyan',
    'if (!(Test-Path -Path $InstallDir)) {',
    '    New-Item -ItemType Directory -Path $InstallDir -Force | Out-Null',
    '}',
    '',
    'Write-Host "[2/4] Initializing Abel AI Configuration, Hotkeys & Anti-Gravity Bridge..." -ForegroundColor Cyan',
    ...
    '',
    'Write-Host "[3/4] Creating Desktop Shortcut for Abel AI..." -ForegroundColor Cyan',
    ...
    '$Shortcut.Save()',
    '',
    'Write-Host "[4/4] Installation Complete! Launching Abel AI..." -ForegroundColor Green',
